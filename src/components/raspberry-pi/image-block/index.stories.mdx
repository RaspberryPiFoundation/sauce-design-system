...
<Story name="Padded image">
  <div
    class="sc-rp-image-block sc-rp-image-block--debug sc-rp-image-block--padded-image"
    style={{ backgroundColor: 'rgb(255, 243, 236)' }}
  >
    <div class="sc-rp-image-block__content">
      <h2 class="sc-rp-type-secondary-heading">Compliance and support</h2>
      <p>
...
<Story name="Reversed with added image">
  <div
    class="sc-rp-image-block sc-rp-image-block--debug sc-rp-image-block--padded-image sc-rp-image-block--reverse"
    style={{ backgroundColor: 'rgb(255, 243, 236)' }}
  >
    <div class="sc-rp-image-block__content">
      <h2 class="sc-rp-type-secondary-heading">Compliance and support</h2>
