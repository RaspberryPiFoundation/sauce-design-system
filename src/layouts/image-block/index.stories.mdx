...
<Story name="Vanilla">
  <div
    class="sl-block sl-block--debug sl-block--image-bottom"
    style={{ backgroundColor: 'rgb(240, 248, 255)' }}
  >
    <div class="sl-block__content">
    ...
    <div class="sl-block__figure">
      <picture class="sl-block__image-container">
...
<Story name="Reversed">
  <div
    class="sl-block sl-block--debug sl-block--reverse"
