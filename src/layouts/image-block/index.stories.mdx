...
Avoid images going "full-bleed" on the `x` axis. Full bleed on one of the edges of the `y` axis is fine, but never both. Vertical image aligment is accomplished with the `.sc-sl-block--image-bottom` and `.sc-sl-block--image-top` modifier classes.
...
In the following examples you can see the quiet area on the images illustrated with a transparent red box. This is enabled with the `.sc-sl-block--debug` modifier. **Do not use this classname in production**.

### Image aligned to bottom of layout

<Story name="Vanilla">
  <div class="sc-sl-block sc-sl-block--debug sc-sl-block--image-bottom" style={{backgroundColor: 'rgb(240, 248, 255)'}}>
    ...
    <div class="sc-sl-block__figure">
      <picture class="sc-sl-block__image-container">
        <source media="(min-width: 600px)"  srcset={christinaSm} />
        <source media="(min-width: 1000px)" srcset={christinaMd} />
        <source media="(min-width: 1300px)" srcset={christinaLg} />
        <img
...
<Story name="Content Reversed">
  <div class="sc-sl-block sc-sl-block--debug sc-sl-block--reversed" style={{backgroundColor: 'rgb(255, 243, 236)'}}>
    <div class="sc-sl-block__content">
      <h2 class="sc-rp-type-secondary-heading">
        Coolest Projects
      </h2>
    ...
    <div class="sc-sl-block__figure">
      <picture class="sc-sl-block__image-container">
        <source media="(min-width: 600px)"  srcset={coolestProjectsSm} />
        <source media="(min-width: 1000px)" srcset={coolestProjectsMd} />
        <source media="(min-width: 1300px)" srcset={coolestProjectsLg} />
        <img
